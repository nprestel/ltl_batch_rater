class LtlRateLookupController < ApplicationController
    	...
    	@ltl_discount = LtlDiscount.get_discount(params[:carrier_scac], @zip_code1.state, @zip_code2.state) if params[:origin_zip].present? && params[:dest_zip].present? && @zip_code1 != "NO MATCH" && @zip_code2 != "NO MATCH"
